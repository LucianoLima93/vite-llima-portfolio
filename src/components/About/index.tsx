    ...
    className='w-full max-w-[900px] mx-auto' id='about'>
      ...
      <div className='w-full grid grid-cols-3/2 gap-12 mt-12'>
        <div>
          ...
          <ul role='list' className='text-sm grid grid-cols-12 w-fit gap-x-8 gap-y-2 marker:text-teal-500 list-disc'>
            <li className='col-span-6 dark:text-teal-300 text-teal-500'>JavaScript (ES6+)</li>
            <li className='col-span-6 dark:text-teal-300 text-teal-500'>TypeScript</li>
            <li className='col-span-6 dark:text-teal-300 text-teal-500'>React</li>
            <li className='col-span-6 dark:text-teal-300 text-teal-500'>Vitest</li>
          </ul>
        </div>
