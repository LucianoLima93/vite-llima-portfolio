  ...
  return (
    <section className="w-full max-w-[900px] mx-auto pt-12 h-[calc(100vh-160px)]">
      <div className="pb-8 px-5 md:px-0 h-[calc(100vh-160px)]">
        ...
        <p className="mb-12 md:w-6/12" data-aos="fade-up" data-aos-duration='500' data-aos-delay="1500">{t('homepage.introThree')}
          <b className="dark:text-teal-300 text-teal-500">{t('homepage.introFour')}</b>{t('homepage.introFive')}</p>
        ...
        <div className='w-full flex justify-center items-center h-min35vh cursor-pointer'>
          <Button
            ...
            icon={<FontAwesomeIcon icon={faAngleDown} className="dark:text-teal-300 text-teal-500 pt-1 md:text-[2em] text-[1.8em]" />}
          />
        </div>
      </div>
    </section>
